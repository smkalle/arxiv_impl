...
| `leaf-taskpilot-2609.07925/` | Leaf + TaskPilot (2609.07925) — LeafCX: Leaf harness + TaskPilot curriculum over a self-serve used-car account-management surface | `AGENTS.md`, `SPEC.md`, `README.md`, `pyproject.toml`, `pytest.ini`, `scripts/termux_setup.sh` | v0.1.0; 167 tests pass; runs on Termux |
