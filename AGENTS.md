...
| `lfm25-grpo-ifstruct/` | GRPO for structured outputs ([HF blog](https://huggingface.co/blog/grpo-with-trl-ifstruct)) — LFM2.5-350M + LoRA + TRL GRPO against the IFStruct benchmark | `README.md`, `lfm25_350m_grpo_structured_outputs.ipynb` | Notebook complete; CPU cells verified, training needs a GPU |
